 ...
 */
export function estimateOutputTokens(responseType) {
    switch (responseType) {
        case 'short':
 ...
 */
export function getMaxOutputTokens(responseType) {
    switch (responseType) {
        case 'short':
 ...
 */
export function logTokenUsage(operation, estimated, actual) {
    if (!actual) {
        console.log(`[TokenUsage] ${operation} - Estimated: ${estimated.total} tokens ` +
    ...
    const percentDiff = estimatedTotal > 0
        ...
        : '0';
    console.log(`[TokenUsage] ${operation}\n` +
 ...
 */
export function calculateTotalEstimate(inputTokens, outputTokens) {
