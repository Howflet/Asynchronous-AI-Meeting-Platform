  ...
  return (
    <div style={{maxWidth:900, margin:'20px auto', padding:20}}>
      ...
      <div style={{marginTop:12}}>
        <input value={author} onChange={(e: any)=>setAuthor(e.target.value)} title="Your name"/>
        <input value={message} onChange={(e: any)=>setMessage(e.target.value)} style={{width:'60%', marginLeft:8}} placeholder="Inject message"/>
